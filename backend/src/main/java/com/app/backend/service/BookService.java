...
public class BookService {
    ...
    private static final String UPLOAD_IMAGE_DIR = "static/images/books/";
    private static final String UPLOAD_FILE_DIR = "static/files/books/";
    ...
    // Créer un livre
    public String addBook(String title, Long authorId, MultipartFile file, MultipartFile image) throws IOException {
